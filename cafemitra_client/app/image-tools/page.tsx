...
const imageTools: ImageTool[] = [
  ...
  { category: "Convert", name: "Convert to JPG", description: "Turn PNG and WebP images into compact JPG files.", badge: "JPG", color: "#efc91e", href: "/image-tools/png-to-jpg" },
  ...
  { category: "Convert", name: "HEIC to JPG", description: "Prepare HEIC photos for conversion into widely supported JPG files.", badge: "HEIC", color: "#efc91e", href: "/image-tools/png-to-jpg" },
  { category: "Convert", name: "SVG Converter", description: "Convert SVG artwork into a standard image format.", badge: "SVG", color: "#efc91e", href: "/image-tools/png-to-jpg" },
  ...
  { category: "Convert", name: "PNG Converter", description: "Convert PNG images into compact, shareable formats.", badge: "PNG", color: "#efc91e", href: "/image-tools/png-to-jpg" },
  { category: "Convert", name: "WebP to JPG", description: "Convert modern WebP images into compatible JPG files.", badge: "JPG", color: "#efc91e", href: "/image-tools/png-to-jpg" },
  ...
  { category: "Convert", name: "GIF Converter", description: "Prepare GIF images for conversion to another format.", badge: "GIF", color: "#efc91e", href: "/image-tools/png-to-jpg" },
