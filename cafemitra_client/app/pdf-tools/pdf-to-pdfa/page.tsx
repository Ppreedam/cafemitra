...
export const metadata: Metadata = {
  title: "Convert PDF to PDF/A Free Online - Archival Format Preparation | RepetiGo",
  description: "Convert any PDF to PDF/A free online - ISO 19005 compliant archival format for courts, government portals, and academic repositories. Best-effort archival preparation. No sign-up. Browser-only processing.",
...
function mapRoute(value: string) {
  ...
  const routes: Record<string, string> = {
    "": "/",
    "/tools/pdf": "/pdf-tools",
    "/tools/pdf/pdf-to-pdf-a": "/pdf-tools/pdf-to-pdfa",
    "/pdf-tools": "/pdf-tools",
  ...
  const schemas = [
    {
      ...
      description: "Free online tool that normalises a PDF's structure and archival metadata as a best-effort starting point for ISO 19005 (PDF/A) preparation. Runs entirely in the browser; validate output with veraPDF for formal compliance.",
      url: pageUrl,
    },
    {
      "@context": "https://schema.org",
      "@type": "HowTo",
      name: "How to Convert PDF to PDF/A Online Free",
      step: [
        { "@type": "HowToStep", name: "Upload Your PDF" },
        { "@type": "HowToStep", name: "RepetiGo Normalises Your PDF" },
        { "@type": "HowToStep", name: "Download and Validate" },
      ],
    },
    {
      "@context": "https://schema.org",
