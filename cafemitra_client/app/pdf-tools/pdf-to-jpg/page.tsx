...
export const metadata: Metadata = {
  ...
  description: "Convert PDF to JPG online free - extract any PDF page as a high-quality image. Choose 96, 150, or 300 DPI. No sign-up. Files auto-deleted after 60 min. Works on any device.",
  alternates: { canonical: pageUrl },
  openGraph: { title: "PDF to JPG Converter Free India - Extract Pages as Images | RepetiGo", description: "Free PDF to JPG converter. Extract pages as high-quality images - 96, 150, or 300 DPI. No sign-up, auto-deleted 60 min.", type: "website", url: pageUrl, images: ["https://repetigo.com/og-pdf-to-jpg.jpg"] },
  twitter: { card: "summary_large_image", title: "PDF to JPG Converter Free - RepetiGo", description: "Convert PDF to JPG free. 96/150/300 DPI. No sign-up, auto-deleted. India-built." },
  robots: { index: true, follow: true },
};

const content = String.raw`H1: PDF to JPG Converter Free. Extract Any PDF Page as a High-Quality Image.
...
H3: 96 DPI - Web and Screen Display
...
H3: 150 DPI - General Purpose and Email
...
H3: 300 DPI - Print Quality and Professional Use
...
Screen Sharpness
96 DPI
Web, social media, email previews
Smallest - 100–400 KB
✗ Pixelated
✓ Sharp on screen
150 DPI
General use, email, digital sharing
Medium - 300–900 KB
~ Acceptable at A5
✓ Sharp on screen
300 DPI
Print, design, professional use
Large - 1–5 MB
✓ Sharp at full A4
✓ Very sharp on screen
...
Upload PDF, select pages, choose DPI, download JPG(s)
Need specific DPI control. Multiple pages. No software available.
Requires internet. File size limit applies.
Adobe Acrobat (paid)
File → Export To → Image → JPEG. Full DPI control.
You have Acrobat Pro and need professional-grade conversion.
...
Only captures screen resolution (96 DPI). Not suitable for print.
Canva (free tier)
...
⭐ RepetiGo's convert PDF to JPG tool is the only free browser-based option that gives you explicit control over output resolution (96, 150, or 300 DPI). This is the key advantage over screenshots, Preview's auto-quality setting, and Canva's fixed output.
...
Your uploaded PDF and all output JPG files are automatically and permanently deleted within 60 minutes of download.
👁️ No Content Is Read
The converter renders PDF pages as images. No text, data, or metadata from your document is extracted, stored, or used for any other purpose.
...
🔒 Your PDF is rendered as images and then deleted within 60 minutes. The output JPG files are also deleted at the same time. RepetiGo never retains any uploaded file or converted output beyond its processing purpose.
