# Generated by Django 5.1.4 on 2026-07-28 16:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attire_category', models.CharField(blank=True, default='', max_length=40)),
                ('gemini_photo', models.CharField(blank=True, default='', max_length=255)),
                ('passport_prompt', models.TextField(blank=True, default='')),
                ('photo_status', models.CharField(blank=True, default='', max_length=20)),
