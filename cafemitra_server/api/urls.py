...
urlpatterns = [
    ...
    re_path(r"^orders/(?P<order_id>[0-9]+)/mark-paid/?$", views.mark_passport_order_paid),
    ...
    re_path(r"^save-raw-passport-photo/?$", views.save_raw_passport_photo),
    re_path(r"^api-passport-photo-check/?$", views.check_passport_photo),
    re_path(r"^agent/passport-jobs/?$", views.agent_passport_jobs),
    re_path(r"^agent/passport-jobs/(?P<job_id>[0-9]+)/claim/?$", views.claim_passport_job),
