...
import { initials, domainOf, followUpState, formatFollowUp, type FollowUpState } from "@/lib/leadFormat";
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-xl font-semibold text-slate-900">Leads Pipeline</h1>
